...
public class UsingDataAndTime {
    ...
    public static void main(String[] args) {
        ...
        id.plusDays(10); // return result is ignored
        System.out.println(id);

        //id.plusMinutes(10); // method does not exist, a trick

        LocalTime it = LocalTime.of(12, 45);
        //it.addDays(3); // method does not exist, another trick

        // plusHours, plusMinutes, plusSeconds, plusNanos are methods that exist
